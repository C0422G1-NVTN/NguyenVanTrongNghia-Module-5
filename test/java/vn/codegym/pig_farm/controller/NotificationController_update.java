...
public class NotificationController_update {
    @Autowired
     ...
     */
    @Test
    public void update_content_13() throws Exception {
     ...
     */
    @Test
    public void update_image_13() throws Exception {
        NotificationDto notificationDto = new NotificationDto();
        notificationDto.setId(1);
        notificationDto.setContent("Ngày mai off nhénnnn");
     ...
     */
    @Test
    public void update_content_14() throws Exception {
        NotificationDto notificationDto = new NotificationDto();
        notificationDto.setId(1);
     ...
     */
    @Test
    public void update_content_15() throws Exception {
        NotificationDto notificationDto = new NotificationDto();
        notificationDto.setId(1);
     ...
     */
    @Test
    public void update_content_18() throws Exception {
        NotificationDto notificationDto = new NotificationDto();
        notificationDto.setId(1);
